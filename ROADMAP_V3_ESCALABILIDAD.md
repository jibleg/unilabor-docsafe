...
| 27 | Validacion de entrada centralizada | Sin libreria de validacion | media | `en progreso` |
...
| 2026-06-12 | Sprint 27 (validacion con Zod) base + entradas criticas | `en progreso` | Middleware `validate` + 400 uniforme; auth, createUser y plan de mantenimiento por esquema; tests verdes. Resto de endpoints como seguimiento incremental. |
