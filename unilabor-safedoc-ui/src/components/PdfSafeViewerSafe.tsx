...
export const PdfSafeViewer = ({ fileUrl }: { fileUrl: string }) => {
  ...
  return (
    <div
      className="relative h-[80vh] overflow-hidden rounded-xl border border-slate-800 bg-slate-950 shadow-inner"
    ...
    >
      <div className="flex items-center justify-between border-b border-slate-800 bg-slate-950/95 px-4 py-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-slate-200 transition hover:bg-slate-800"
            title="Reducir zoom"
          >
            <ZoomOut size={16} />
          </button>
          <span className="min-w-16 text-center text-xs font-semibold text-slate-300">
          ...
          <button
            ...
            disabled={!canGoBack}
            className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-slate-200 transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
            title="Pagina anterior"
          >
            <ChevronLeft size={16} />
          </button>
          <span className="min-w-24 text-center text-xs font-semibold text-slate-300">
      ...
      <div className="relative h-[calc(80vh-73px)] overflow-auto bg-[linear-gradient(180deg,#020617_0%,#111827_100%)] p-6">
        <div
        ...
        <div className="relative z-10 mx-auto flex w-fit justify-center no-select">
          ...
          >
            <div className="relative rounded-2xl border border-slate-800 bg-white/95 p-2 shadow-2xl shadow-black/40">
              <Page
